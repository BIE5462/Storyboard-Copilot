...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            image::save_image_source_with_dialog,
            image::pick_download_preset_directory,
            image::remove_download_preset_directory,
            image::save_image_source_to_preset_directory,
            image::save_storyboard_images_to_directory,
            image::save_image_source_to_app_debug_dir,
            image::copy_image_source_to_clipboard,
            ai_commands::set_api_key,
            ai_commands::set_qianhai_generation_policy,
            ...
            project_state::prune_project_image_cache,
